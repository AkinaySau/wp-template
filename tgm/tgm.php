<?php
/**
 * This file represents an example of the code that themes would use to
 * register
 ...
 *
 * @see        http://tgmpluginactivation.com/configuration/ for detailed
 *             documentation.
 *
 ...
 * '/path/to/class-tgm-plugin-activation.php';
 *
 * Child Theme:
 ...
 * - two from an external source, one from an arbitrary source, one from a
 * GitHub repository
 * - two from the .org repo, where one demonstrates the use of the
